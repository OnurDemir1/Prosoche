...
const ZEN_QUOTES = {
  ...
  tr: [
    ...
    'Yorulmamak üzere yola çıkanlar, asla yorulmazlar.',
    ...
    'Bir şeyi yapmak istersen bir yol bulursun, yapmak istemezsen bir bahane bulursun.',
    'Sabır, kurtuluşun anahtarıdır.',
    'Yarın diyene aldanma; bugün dündür, dün bugündür.',
    'Düzenim bozulur, hayatım alt üst olur diye endişe etme. Nereden biliyorsun hayatın altının üstünden daha iyi olmayacağını?',
    'Başarı, kişinin kapasitesiyle ulaştığı yer arasındaki farktır.',
    'Her büyük başarı, önce bir hayalle başlar.',
    'Hayat beklediğin yerden değil, başladığın yerden başlar.',
    'Matematik esas olarak sabır olayıdır. Belleyerek değil keşfederek anlamak gerekir.',
    'Zamanını boşa harcayan, hayatını boşa harcamış olur.',
    ...
    'Bilgi bir hazinedir, ancak uygulandığında bir güç olur.',
    'Azim, engelleri aşan en büyük güçtür.',
    'Durmak devrilmek demektir, yürümek hayat demektir.',
    'Zamanın dışında değil, tam içindeyiz.',
    'Disiplin olmadan yetenek bir hiçtir.',
    'Düşünmek ve yapmak arasındaki mesafe, hayatın kendisidir.',
    'Çalışmadan geçinenler bizden değildir.',
    'İnsan dünyaya sadece yemek, içmek ve uyumak için gelmiş olamazdı. Daha büyük bir amaç lazımdı.'
  ]
};
